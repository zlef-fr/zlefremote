...
const ZRI18n = (() => {
  const S = {
    en: {
      ...
      switch_desktop: 'On a computer? The desktop remote gives you the screen, your mouse and your keyboard.',
      switch_open: 'Open it', switch_stay: 'Stay here',
      tab_pad: 'Trackpad', tab_keys: 'Keyboard', tab_media: 'Media', tab_screen: 'Screen',
      hint_pad: 'Drag · tap · 2 fingers scroll · pinch zooms · 3 fingers switch app',
      ...
      screen_hint: 'Tap to click · double-tap = double-click · two-finger tap = right-click · two fingers scroll · drag to move the pointer',
      ...
      bright_all: 'All', bright_screen: 'Screen', bright_via: 'Brightness method',
      ...
      gestures_note: 'Three-finger swipes, the sideways two-finger flick, pinch to zoom. Scrolling and the two-finger right-click stay either way.',
    ...
    fr: {
      ...
      switch_desktop: 'Sur un ordinateur ? La télécommande bureau vous donne l’écran, votre souris et votre clavier.',
      switch_open: 'L’ouvrir', switch_stay: 'Rester ici',
      tab_pad: 'Trackpad', tab_keys: 'Clavier', tab_media: 'Média', tab_screen: 'Écran',
      hint_pad: 'Glissez · tapez · 2 doigts défilent · pincer zoome · 3 doigts changent d’app',
      ...
      screen_hint: 'Tap pour cliquer · double-tap = double-clic · tap à 2 doigts = clic droit · 2 doigts défilent · glissez pour déplacer le pointeur',
      ...
      bright_all: 'Tous', bright_screen: 'Écran', bright_via: 'Méthode de luminosité',
      ...
      gestures_note: 'Balayages à trois doigts, balayage latéral à deux doigts, pincer pour zoomer. Le défilement et le clic droit à deux doigts restent dans tous les cas.',
