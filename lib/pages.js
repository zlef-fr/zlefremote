  ...
  en: {
    ...
    sections: [
      ...
      { h: 'The agent on your computer', p: [
        ...
        'The agent contains no analytics and no telemetry. Its source code is public, so anyone can verify this.',
      ] },
  ...
  fr: {
    ...
    sections: [
      ...
      { h: 'L’agent sur votre ordinateur', p: [
        ...
        'L’agent ne contient aucune analyse d’audience ni télémétrie. Son code source est public : chacun peut le vérifier.',
      ] },
